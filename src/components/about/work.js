	...
	return (
		<Job at="Mozilla" role="Staff Software Engineer">
			<p>
				...
				speech of all types, spanning over 60 languages. For many,
				voice recognition and synthesis is the primary interface for
				their devices. Common Voice is an open, inclusive, and
				privacy-conscious standard for a technology that is rapidly
				becoming ubiquitous. Here are some highlights of my time there:
			</p>
			<ul>
				<li>
