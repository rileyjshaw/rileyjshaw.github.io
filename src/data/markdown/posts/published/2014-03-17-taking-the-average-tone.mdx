...
If you took the average color of a beautiful painting, it would likely turn out muddy brown. Today, I created the audio equivalent:

[Blazo’s Misty Sapphire](https://youtu.be/rlyYQlPrdac):

<iframe
	title="Average tone: Misty Sapphire"
	width="100%"
	height="124"
	scrolling="no"
	frameBorder="no"
	src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/139984944&amp;color=ff5500&amp;auto_play=false&amp;hide_related=true&amp;show_artwork=false"
></iframe>

[Steve Reich’s Music for 18 Musicians](https://youtu.be/E_jwv2QMtAo):

<iframe
	title="Average tone: Music For 18 Musicians"
	width="100%"
	height="124"
	scrolling="no"
	frameBorder="no"
	src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/139984941&amp;color=ff5500&amp;auto_play=false&amp;hide_related=true&amp;show_artwork=false"
></iframe>

[Kill the Noise remix of KOAN Sound’s Talk Box](https://youtu.be/f-6H8NsfPNQ):

<iframe
	title="Average tone: Talk Box (Kill The Noise Remix)"
	width="100%"
	height="124"
	scrolling="no"
	frameBorder="no"
	src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/139984943&amp;color=ff5500&amp;auto_play=false&amp;hide_related=true&amp;show_artwork=false"
></iframe>
...
<Figure caption="C major chord in the frequency-domain">

![C Major chord in the frequency domain](../../../../../content/images/blog/c_major_freq.png)
...
<Figure caption="C major chord in the time-domain">

![C Major chord in the time domain](../../../../../content/images/blog/c_major_time.png)

</Figure>

Wikipedia has the best gif I’ve ever seen for this:

<Figure caption="Fourier transform between the time and frequency domains">

![Fourier transform between the time and frequency domains](https://upload.wikimedia.org/wikipedia/commons/7/72/Fourier_transform_time_and_frequency_domains_%28small%29.gif)
...
Next, we use scipy’s <code className="language-python">wavfile.read</code> to return the audio’s sample rate and audio contents.
...
Next we need to split the song into chunks to send through the <code className="language-python">average_frequency</code> function. Since we know our sample rate (samples / second) and tempo (beats / minute) already, we can figure out how many samples make up a beat and slice it up.
...
Here we’re using a function called <code className="language-python">grouper</code> that lets us slice up the data. It’s described in depth in [itertools’ Recipes section](https://docs.python.org/2/library/itertools.html#recipes).
...
And we’re done! The whole thing (including my <code className="language-python">composer</code> module), is on [Github](https://github.com/rileyjshaw/mean-tone).
...
<iframe
	title="Average tone / beat: Bandoliers"
	width="100%"
	height="124"
	scrolling="no"
	frameBorder="no"
	src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/139987561&amp;color=ff5500&amp;auto_play=false&amp;hide_related=true&amp;show_artwork=false"
></iframe>

[The Chemical Brothers’ Another World](https://youtu.be/oMu9H7Bkb1Y):

<iframe
	title="Average tone / beat: Another World"
	width="100%"
	height="124"
	scrolling="no"
	frameBorder="no"
	src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/139984938&amp;color=ff5500&amp;auto_play=false&amp;hide_related=true&amp;show_artwork=false"
></iframe>

[Brian Eno’s 2-1](https://youtu.be/AQLh3WanSfg):

<iframe
	title="Average tone / beat: 2-1"
	width="100%"
	height="124"
	scrolling="no"
	frameBorder="no"
	src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/139985315&amp;color=ff5500&amp;auto_play=false&amp;hide_related=true&amp;show_artwork=false"
></iframe>
...
[^1]: The arrow looks like this:
    ...
    ![Audacity track side-menu](../../../../../content/images/blog/audacity_arrow.png)

[^2]: Thanks Nolan Beck for the heads up!

    ![Nyquist legacy syntax option](../../../../../content/images/blog/audacity_legacy_checkbox.png)

[^3]: A 440Hz sine wave, for example, sounds like an **A** to our ears.
[^4]: Including one I wrote called <code className="language-python">composer</code>, which generates an audio signal from the frequencies we pass it
