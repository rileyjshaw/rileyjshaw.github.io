...
import ScalingFadersDemo from 'components/ScalingFadersDemo';
...
The loops are from Garageband, so I can’t take credit for the transcendant flute riff on Track 7. But hopefully they illustrate my idea. If you really want to dig into the details, [the code](https://github.com/rileyjshaw/rileyjshaw.github.io/blob/dev/src/components/ScalingFadersDemo.jsx) (like everything on my website) is open source. [There’s also a Codepen](https://codepen.io/rileyjshaw/pen/ZEOqdPM?editors=0010) that you can remix.
