...
Now I make music with a keyboard or drum pad connected to my computer. It’s the same computer that I spend most of my time programming on. Making music looks like this now:

1. Remain seated.
2. Minimize my work software. Open my music software.
3. Update music software to latest version.
...
As an amateur with no focus, I rarely reach the point in a song where I need to worry about the mix or arrangement. But sometimes I do, and when I do, I do it badly.

When I add a new track to a song, I make it too loud. Then when I’m mixing, I make everything as loud as the loudest track. “Mixing” for me means depleting headroom until something starts clipping and I start over from scratch.
...
Last weekend, I made something new. Of course. And I’m having fun with it. But I’m also kind of surprised I haven’t seen this type of UI before. Is this not a problem other people have? Are faders old-timey now because the pros mix their tracks with machine learning? I searched terms like “auto-scaling fader bank” and “mixer keep average”, but nothing is coming up.
...
The loops are from Garageband, so I can’t take credit for the transcendant flute riff on Track 7. But hopefully this illustrates the idea. If you really want to dig into the details, [the code](https://github.com/rileyjshaw/rileyjshaw.github.io/blob/dev/src/components/scaling-faders-demo.js) (like everything on my website) is open source. [There’s also a Codepen](https://codepen.io/rileyjshaw/pen/ZEOqdPM?editors=0010) that you can remix.

I’m happy that my website doesn’t have a comments section (or analytics, webfonts, and other ad tracking vectors) but today I’m curious to hear what Real Musicians think of this interface. So I’ll post this to Reddit in case in case anyone has thoughts. [Feel free to comment there!](https://reddit.com)
